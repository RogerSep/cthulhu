  ...
  render() {
    ...
    return this.props.connectDragSource(
      <div styleName="marker">
        <svg style={position} width="33px" height="50px" viewBox="0 0 33 50" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <g stroke="none" fill="none" fill-rule="evenodd">
            <g className="drop-marker">
              ...
              <path d="M16.3340336,48.6899878 C24.4242247,48.6899878 30.9826203,42.1471305 30.9826203,34.076107 C30.9826203,26.0050836 16.3340336,2.79814272 16.3340336,2.79814272 C16.3340336,2.79814272 1.68544691,26.0050836 1.68544691,34.076107 C1.68544691,42.1471305 8.24384257,48.6899878 16.3340336,48.6899878 Z" fill="#4990E2" />
            </g>
          </g>
        </svg>
      </div>
